...
//
// It is deliberately separate from any transport. One product carries these messages over a resident
...
type Msg struct {
	...
	// already survives on the device (after a server restart or an in-place update
