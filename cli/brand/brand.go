...
// Current is the brand this process is. A product sets it at startup, before anything reads a path
// or an environment variable. The default is deliberately generic and deliberately not anyone's
